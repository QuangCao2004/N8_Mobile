...
public class TrangCaNhan_admin_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Khởi tạo TextView để hiển thị tên đăng nhập
        TextView tendnTextView = findViewById(R.id.tendn);

        // Lấy tên đăng nhập từ SharedPreferences
        SharedPreferences sharedPreferences = getSharedPreferences("MyPrefs", MODE_PRIVATE);
        String tendn = sharedPreferences.getString("tendn", "Tên đăng nhập");

        // Cập nhật TextView với tên đăng nhập
        tendnTextView.setText(tendn);

        // (Tùy chọn) Kiểm tra nếu tên rỗng, hiển thị thông báo
        if (tendn.equals("Tên đăng nhập")) {
            tendnTextView.setText("Chưa đăng nhập");
        }
